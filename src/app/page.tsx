        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-emerald-100">
              <li><button onClick={() => navigateToPage('about')} className="hover:text-white transition-colors">About Us</button></li>
              <li><button onClick={() => navigateToPage('products')} className="hover:text-white transition-colors">Products</button></li>
              <li><button onClick={() => navigateToPage('export')} className="hover:text-white transition-colors">Export & Sourcing</button></li>
    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="w-full h-96 bg-gradient-to-br from-emerald-200 to-emerald-400 rounded-2xl shadow-lg flex items-center justify-center">
                <div className="text-center text-emerald-800">
                  <Globe size={80} className="mx-auto mb-4" />
                  <p className="text-lg font-semibold">Global Trade Network</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-gradient-to-r from-emerald-600 to-emerald-800 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button 
            onClick={() => navigateToPage('contact')}
            className="bg-white text-emerald-600 px-8 py-3 rounded-lg font-medium hover:bg-emerald-50 transition-colors">
            Get Started Today
          </button>
        </div>
      </section>
    ...
    <div className="min-h-screen py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="w-full h-96 bg-gradient-to-br from-blue-200 to-blue-400 rounded-2xl shadow-lg flex items-center justify-center">
            <div className="text-center text-blue-800">
              <Globe size={80} className="mx-auto mb-4" />
              <p className="text-lg font-semibold">Global Operations</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="w-full h-96 bg-gradient-to-br from-emerald-200 to-emerald-400 rounded-2xl shadow-lg flex items-center justify-center">
            <div className="text-center text-emerald-800">
              ...
              <p className="text-lg font-semibold">Excellence in Service</p>
            </div>
          </div>
        </div>
